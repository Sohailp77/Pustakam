<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div>
                    <a href="<?php print(base_url()); ?>admin/chapter/create_chapter/<?=$cid?>" class="btn btn-success waves-effect waves-light mb-3">Add Chapter Images</a>
                </div>
            </div>
        </div>
